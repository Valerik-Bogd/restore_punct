...
FILTERED = "/home/temari/god please no diploma/restore_punct/data/rare_punct_FILTERED.json"

TARGET_IDS = frozenset({6, 12, 13, 16, 17, 19, 20, 21, 22, 24, 25})

MAX_EXAMPLES_PER_CLASS = 5_000
MAX_TOTAL              = 60_000
...
with open(GIANT, "r", encoding="utf-8") as fin, \
    ...
    fout.write("[\n")
    for line in tqdm(fin, desc="Filtering 151 GB"):
        line = line.strip()
